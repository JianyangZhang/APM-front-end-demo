...
export var cpu1Opt = createLineOption("%user", xData, cpu1_data, purple, 100, 0, 20);
export var cpu2Opt = createLineOption("%nice", xData, cpu2_data, green, 100, 0, 20);
export var cpu3Opt = createLineOption("%system", xData, cpu3_data, blue, 100, 0, 20);
export var cpu4Opt = createLineOption("%iowait", xData, cpu4_data, blue, 100, 0, 20);
export var cpu5Opt = createLineOption("%steal", xData, cpu5_data, purple, 100, 0, 20);
export var cpu6Opt = createLineOption("%idle", xData, cpu6_data, green, 100, 0, 20);
export var cpu7Opt = createLineOption("%used", xData, cpu7_data, blue, 100, 0, 20);
...
export var mem1Opt = createLineOption("used/mb", xData, mem1_data, purple, 16*1024, 0, 4*1024);
export var mem2Opt = createLineOption("%used", xData, mem2_data, green, 100, 0, 20);
export var mem3Opt = createLineOption("buffers/mb", xData, mem3_data, blue, 16*1024,0, 4*1024);
export var mem4Opt = createLineOption("cached/mb", xData, mem4_data, blue, 16*1024, 0, 4*1024);
export var mem5Opt = createLineOption("swap free/mb", xData, mem5_data, purple, 16*1024, 0,4*1024);
export var mem6Opt = createLineOption("swap used/mb", xData, mem6_data, green, 16*1024, 0,4*1024);
export var mem7Opt = createLineOption("%swap", xData, mem7_data, blue, 100, 0, 20);
export var mem8Opt = createLineOption("%swpcad", xData, mem8_data, blue, 100, 0, 20);
...
export var disk1Opt = createLineOption("tps", xData, disk1_data, purple, null, null, 300);
export var disk2Opt = createLineOption("rpts", xData, disk2_data, green, null, null, 300);
export var disk3Opt = createLineOption("wpts", xData, disk3_data, blue, null, null, 300);
export var disk4Opt = createLineOption("bread/s", xData, disk4_data, blue, null, null, 50);
export var disk5Opt = createLineOption("bwrtn/s", xData, disk5_data, purple, null, null, 50);
...
export var eth0ByteOpt = createNetworkLineOption("eth0 收发字节数", eth0_bytes_data1, eth0_bytes_data2)
export var eth0PktOpt = createNetworkLineOption("eth0 收发报文数", eth0_pkt_data1, eth0_pkt_data2)
export var eth0ErrorOpt = createNetworkLineOption("eth0 收发错包数", eth0_error_data1, eth0_error_data2)
export var eth0DropOpt = createNetworkLineOption("eth0 收发丢包数", eth0_drop_data1, eth0_drop_data2)
...
export var eth1ByteOpt = createNetworkLineOption("eth1 收发字节数", eth1_bytes_data1, eth1_bytes_data2)
export var eth1PktOpt = createNetworkLineOption("eth1 收发报文数", eth1_pkt_data1, eth1_pkt_data2)
export var eth1ErrorOpt = createNetworkLineOption("eth1 收发错包数", eth1_error_data1, eth1_error_data2)
export var eth1DropOpt = createNetworkLineOption("eth1 收发丢包数", eth1_drop_data1, eth1_drop_data2)